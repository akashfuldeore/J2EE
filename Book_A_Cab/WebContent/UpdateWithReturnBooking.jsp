...
<link rel="stylesheet" href="UpdateWithReturnBooking.css">
</head>
<body>
...
<div class="column" >
<img src="UpdateWithWithoutBooking.jpg"  width="620" height="580">

</div>

<div class="column" >
	<spr:form action="UpdateWithReturnBooking.ext" method="post" commandName="withReturnBooking" >
	<table align="left" style="margin-left: 30px; margin-top: 10px" >
		...
		<tr>
			...
			<td>
				<spr:input path="DropDate"/>
			</td>
			<td>
			    Drop Time :
			</td>
			<td><br>
				<spr:input path="DropTime"/><br><br>
			</td>
		</tr>
