...
<html>
<head>
<link rel="stylesheet" href="WithReturn.css">
<meta charset="ISO-8859-1">
<title>WithReturn</title>
</head>
<body>

	<div class="row">
	<div class="column" >
	<img src="WithWithoutReturn.png"  width="620" height="580">
	</div>
	
	
	<div class="column" >
	<spr:form action="WithReturn.ext" method="post" commandName="withReturn" >
