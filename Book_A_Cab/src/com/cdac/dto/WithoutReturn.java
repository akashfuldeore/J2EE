...
public class WithoutReturn {
	...
	public WithoutReturn(int userId, String userName, String mobNo, String emailId, String noOfPas, String pickUpAddr,
			String pickUpDate, String pickUpTime, String dropAddr, String category) {
		super();
		this.userId = userId;
	...
	public WithoutReturn(int bookingId) {
		super();
